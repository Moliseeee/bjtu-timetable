...
COURSES = [
    {"code": "C108001B", "name": "微积分(B)I", "teacher": "余爱梅",
     "slots": [(1, 1, 1, 16, 1), (4, 1, 1, 16, 1), (2, 2, 1, 16, 1)]},
    {"code": "C108004B", "name": "几何与代数(B)", "teacher": "王雅婷",
     "slots": [(2, 1, 1, 16, 1), (3, 2, 1, 12, 1)]},
    {"code": "A121001B", "name": "体育I", "teacher": "高媛",
     "slots": [(3, 1, 1, 16, 1)]},
    {"code": "C102017B", "name": "大学计算机", "teacher": "周果,李宜芳",
     "slots": [(1, 2, 9, 16, 1)]},
    {"code": "A123005B", "name": "公民素养与全面发展", "teacher": "唐薇",
     "slots": [(4, 3, 1, 16, 1)]},
    {"code": "A019001B", "name": "国家安全教育",
     "teacher": "周紫红,刘雪,杜晔,何洁,杨启航,李安,安高,刘娟娟",
     "slots": [(5, 3, 9, 16, 1)]},
    {"code": "M203002B", "name": "管理学原理", "teacher": "常耀峰",
     "slots": [(1, 4, 1, 12, 1), (3, 5, 1, 12, 1)]},
    {"code": "C112003B", "name": "中级综合英语", "teacher": "李涵",
     "slots": [(2, 4, 1, 12, 1), (4, 4, 1, 12, 1)]},
    {"code": "M203012B", "name": "Python基础及应用", "teacher": "陈东东",
     "slots": [(3, 4, 1, 16, 1), (4, 5, 2, 16, 2)]},   # 周四第5节 双周(2,4,...,16周)
    {"code": "M103001B", "name": "专业导论",
     "teacher": "周耀东,张姗姗,周建勤,任旭,刘颖琦,穆文歆,赵晓军,肖迪",
     "slots": [(5, 4, 1, 2, 1), (5, 4, 5, 6, 1),
               (5, 5, 1, 2, 1), (5, 5, 5, 6, 1),
               (5, 6, 1, 2, 1), (5, 6, 5, 6, 1)]},
    {"code": "A022014B", "name": "大学生心理健康", "teacher": "胡永清",
     "slots": [(1, 5, 9, 16, 1)]},
    {"code": "A103982B", "name": "商业礼仪与沟通", "teacher": "王砚岩",
     "slots": [(2, 5, 1, 8, 1)]},
    {"code": "A032001B", "name": "高铁纵横", "teacher": "贾顺欢",
     "slots": [(2, 6, 5, 12, 1)]},
    {"code": "A109019B", "name": "习近平新时代中国特色社会主义思想概论",
     "teacher": "王楠,冯蕾", "slots": [(4, 6, 1, 16, 1), (4, 7, 1, 16, 1)]},
]
...
LOCATIONS = {
    ...
    ("Python基础及应用", 4): "海淀东校区 东区一教 DQ410",
